...
vaegan = VAEGAN(latent_dim, input_dim, output_dim, n_classes, batch_size)
...
for epoch in range(epochs):
    ...
    for x_real_580, x_real, y_real in train_dataset:
        ...
        gen_epoch_accuracy.update_state(y_fake, vaegan.discriminator.predict(x_fake)[0])
        disc_epoch_accuracy.update_state(y_real, vaegan.discriminator.predict(x_real)[0])
